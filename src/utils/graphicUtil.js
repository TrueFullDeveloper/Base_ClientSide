...
export const lenearFunction = (x, x1, x2, y1, y2) =>
  Math.round(((x - x1) / (x2 - x1)) * (y2 - y1) + y1);

export const refreshLine = (lineRef, graphicArray) => {
...
export const setGraphic = (graphicData, periodType, contextRef) => {
...
export const drawMark = (lineRef, markValue, coordinate) => {
  // Draw Circle
